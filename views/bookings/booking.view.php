    ...
    <form action="../../controllers/bookings/atm/atm_momo.php" method="get">
            ...
            <div class="row d-flex mb-3 justify-content-center">
              <div class="col-9 d-flex flex-column justify-content-end mt-2  time_pick">
                <div class="row d-flex gap-4 mt-2 line1">
                  <div class="col-2">
                    <input type="radio" class="btn-check time-label" name="time" id="time1" value="9"
                      autocomplete="off">
                    <label class="btn" for="time1">9:00</label>
                  </div>
                  <div class="col-2">
                    <input type="radio" class="btn-check time-label" name="time" id="time2" value="10"
                      autocomplete="off">
                    <label class="btn" for="time2">10:00</label>
                  </div>
                  <div class="col-2">
                    <input type="radio" class="btn-check time-label" name="time" id="time3" value="11"
                      autocomplete="off">
                    <label class="btn" for="time3">11:00</label>
                  </div>
                  <div class="col-2">
                    <input type="radio" class="btn-check time-label" name="time" id="time4" value="12"
                      autocomplete="off">
                ...
                <div class="row d-flex gap-4 line2 mt-3">
                  <div class="col-2">
                    <input type="radio" class="btn-check time-label" name="time" id="time5" value="13"
                      autocomplete="off">
                    <label class="btn" for="time5">13:00</label>
                  </div>
                  <div class="col-2">
                    <input type="radio" class="btn-check time-label" name="time" id="time6" value="14"
                      autocomplete="off">
                    <label class="btn" for="time6">14:00</label>
                  </div>
                  <div class="col-2">
                    <input type="radio" class="btn-check time-label" name="time" id="time7" value="15"
                      autocomplete="off">
                    <label class="btn" for="time7">15:00</label>
                  </div>
                  <div class="col-2">
                    <input type="radio" class="btn-check time-label" name="time" id="time8" value="16"
                      autocomplete="off">
                ...
                <div class="row d-flex gap-4 line3 mt-3">
                  <div class="col-2">
                    <input type="radio" class="btn-check time-label" name="time" id="time9" value="17"
                      autocomplete="off">
      ...
      <div class="row mt-4">
        <div class="col-6 d-flex total_bkig">
          ...
          <input type="text" id="total_dispoint" name="total_dispoint" class="col-5 text-danger"></input>
        </div>
        <script>
